...
<svg width="100%" height="100%" viewBox="0 0 300 40"
      ...
      <rect x="5" y="12" width="290" height="16" rx="8" fill="var(--vfd-metal-800)" :stroke="strokeColor" stroke-width="2.5" />
      <circle cx="20" cy="20" r="6" fill="var(--vfd-metal-500)" stroke="var(--vfd-metal-700)" />
      <circle cx="20" cy="20" r="2" fill="var(--vfd-metal-800)" />
      <circle cx="105" cy="20" r="6" fill="var(--vfd-metal-500)" stroke="var(--vfd-metal-700)" />
      <circle cx="105" cy="20" r="2" fill="var(--vfd-metal-800)" />
      <circle cx="195" cy="20" r="6" fill="var(--vfd-metal-500)" stroke="var(--vfd-metal-700)" />
      <circle cx="195" cy="20" r="2" fill="var(--vfd-metal-800)" />
      <circle cx="280" cy="20" r="6" fill="var(--vfd-metal-500)" stroke="var(--vfd-metal-700)" />
      <circle cx="280" cy="20" r="2" fill="var(--vfd-metal-800)" />
      ...
      <line x1="8" y1="31" x2="292" y2="31" stroke="var(--vfd-metal-600)" stroke-width="2" stroke-dasharray="4 4" />
    </svg>
</template>
