...
<svg width="100%" height="100%" viewBox="0 0 100 120" preserveAspectRatio="none">
      <!-- Boiler Outer Shell -->
      <rect x="10" y="20" width="80" height="90" rx="8" ry="8" fill="var(--vfd-metal-700)" :stroke="strokeColor" stroke-width="3" />
      <!-- Top Chimney -->
      <rect x="40" y="5" width="20" height="15" fill="var(--vfd-metal-600)" :stroke="strokeColor" stroke-width="2" />
      <line x1="35" y1="5" x2="65" y2="5" stroke="var(--vfd-metal-800)" stroke-width="3" />

      <!-- Glowing Furnace Window -->
      <circle cx="50" cy="70" r="22" fill="var(--vfd-metal-800)" stroke="var(--vfd-metal-600)" stroke-width="2" />
      ...
      <rect x="18" y="30" width="6" height="30" rx="3" fill="var(--vfd-metal-800)" />
      ...
      <path d="M 85 40 L 95 40 L 95 48 M 90 40 L 90 35" stroke="var(--vfd-metal-600)" stroke-width="2" fill="none" />
    </svg>
</template>
