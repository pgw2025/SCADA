...
namespace ScadaServer.Infrastructure.Migrations
{
    ...
    [Migration("20260921203000_FixVariableHistoryUniqueIndexDeviceId")]
    partial class FixVariableHistoryUniqueIndexDeviceId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DataConversion", b =>
                {
                    ...
                    b.Property<string>("OutOfRangePolicy")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16)")
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DataPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DataPointMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AccessModeOverride")
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16)");
                    ...
                    b.HasIndex("DeviceId", "DataPointId")
                        .IsUnique()
                        .HasDatabaseName("ix_devicevariable_device_model");

                    b.ToTable("DataPointMappings", (string)null);
                });
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DatabaseConfig", b =>
                {
                    ...
                    b.Property<long?>("MigrateLastId")
                        .HasColumnType("bigint");

                    b.Property<string>("MigrateStatus")
                        .HasColumnType("longtext");

                    b.Property<DateTime?>("MigrateUpdatedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.Device", b =>
                {
                    ...
                    b.Property<DateTime?>("RunStateChangedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DeviceDataModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeviceId", "DataModelId")
                        .IsUnique()
                        .HasDatabaseName("ix_devicedatamodels_device_model");

                    b.ToTable("DeviceDataModels", (string)null);
                });
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.HmiWidgetTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PropSchemaJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RenderKind")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16)");
                    ...
                    b.ToTable("HmiWidgetTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.NotificationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.PushSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("RenewalToken")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.ScadaPageFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ScadaPageFolders", (string)null);
                });
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.ScadaProjectAuthorization", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ScadaProjectAuthorizations", (string)null);
                });
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.VariableHistory", b =>
                {
                    ...
                    b.HasIndex("VariableKey", "Timestamp", "DeviceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DataPointMapping", b =>
                {
                    ...
                    b.HasOne("ScadaServer.Domain.Entities.DataPoint", "DataPoint")
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.DeviceDataModel", b =>
                {
                    b.HasOne("ScadaServer.Domain.Entities.DataModel", "DataModel")
                        .WithMany()
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.ScadaPage", b =>
                {
                    b.HasOne("ScadaServer.Domain.Entities.ScadaPageFolder", null)
                        .WithMany("Pages")
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.ScadaPageFolder", b =>
                {
                    b.HasOne("ScadaServer.Domain.Entities.ScadaPageFolder", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("ScadaServer.Domain.Entities.ScadaProjectAuthorization", b =>
                {
                    b.HasOne("ScadaServer.Domain.Entities.ScadaProject", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("ScadaServer.Domain.Entities.SystemUser", null)
                        .WithMany()
