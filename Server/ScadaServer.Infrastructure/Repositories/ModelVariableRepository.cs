...
namespace ScadaServer.Infrastructure.Repositories
{
    /// <summary>
    /// 模型变量仓储实现。
    /// 对应实体 <see cref="ModelVariable"/>，数据表 ModelVariables（数据模型下的变量模板定义：
    ...
    public class ModelVariableRepository : RepositoryBase<ModelVariable, int>, IModelVariableRepository
    {
        ...
        /// 获取全部模型变量列表。
        /// </summary>
        /// <returns>全部 <see cref="ModelVariable"/> 列表，按 ModelId、Key 稳定升序排列。</returns>
        /// <remarks>
        ...
        /// <returns>满足条件且按 Key 稳定升序排列的 <see cref="ModelVariable"/> 列表。</returns>
        /// <remarks>
